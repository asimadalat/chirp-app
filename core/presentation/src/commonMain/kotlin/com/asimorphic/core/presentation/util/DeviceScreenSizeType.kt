...
enum class DeviceScreenSizeType {
    MOBILE_PORTRAIT,
    MOBILE_LANDSCAPE,
    TABLET_PORTRAIT,
    TABLET_LANDSCAPE,
    ...
    val isWideView: Boolean get() =
        this in listOf(TABLET_LANDSCAPE, DESKTOP)

    companion object {
        fun fromWindowSizeClass(
            windowSizeClass: WindowSizeClass
        ): DeviceScreenSizeType {
...
@Composable
fun currentDeviceScreenSizeType(): DeviceScreenSizeType {
    val windowSizeClass: WindowSizeClass = currentWindowAdaptiveInfo().windowSizeClass
    return DeviceScreenSizeType.fromWindowSizeClass(windowSizeClass)
}